...
Planet bluePlanetMoon = new Planet();
Planet bluePlanetMoon2 = new Planet();
Planet redPlanetMoon = new Planet();
...
void setup() {
  ...
  bluePlanetMoon.setup(30, 7, 5, 0, 255, 0);
  bluePlanetMoon2.setup(50, 9, 10, 255, 255, 0);
  redPlanetMoon.setup(60, 10, 10, 0, 255, 255);
  
  redPlanetMoon.setGetPreviousMatrix(false);
  bluePlanetMoon.setGetPreviousMatrix(false);
  bluePlanetMoon.setInitialPush(true);
  bluePlanetMoon2.setGetPreviousMatrix(false);
  bluePlanetMoon2.setInitialPop(true);
